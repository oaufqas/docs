...
- **Безопасность:** Внутри Kubernetes они хранятся в формате **Base64** (это НЕ шифрование, это просто кодировка). В `etcd` они могут быть зашифрованы, если админ это настроил в rbac.
