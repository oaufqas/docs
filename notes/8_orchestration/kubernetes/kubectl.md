...
| `kubectl delete all --all -n <namespace>` | Удалить все сущности с определенного namespace             |

##### Контекст

| Команда                                          | Описание                        |
| ------------------------------------------------ | ------------------------------- |
| `kubectl config get-contexts`                    | Все кластеры из конфига         |
| `kubectl config use-context <имя_контекста>`<br> | Переключиться на другой кластер |
