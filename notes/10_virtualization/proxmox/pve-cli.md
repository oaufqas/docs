**`pve-cli`** — это общее неофициальное название мощного набора встроенных утилит командной строки (CLI) для ==управления гипервизором Proxmox VE==. Утилит представленых ниже НЕТ на других дистрибутивах.
